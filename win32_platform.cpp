...
input.buttons[b].changed = true;\
                    ...
                    // Switching which button is being pressed
                    switch (vk_code) {
        ...
        // Render
        StretchDIBits(hdc, 0, 0, render_state.width, render_state.height, 0, 0, render_state.width, render_state.height, render_state.memory, &render_state.bitmap_info,
